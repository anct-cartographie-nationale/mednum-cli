...
describe('deduplication comparison to csv', (): void => {
  it('should get duplication comparison ready to write in CSV file', (): void => {
    ...
    expect(duplicationComparisonCSV).toBe<string>(
      'Score;Typologie 1;Typologie 2;Score Nom;Nom 1;Nom 2;Score Adresse;Adresse 1;Adresse 2;Distance en metres;Localisation 1;Localisation 2;Source 1;Source 2\n25;ESS;ESS;38;Numerinaute;La Turbine.Coop;20;12 Rue Joseph Rey  chez Aconit 38000 Grenoble;5 esplanade Andry Farcy 38000 Grenoble;957;45.186115 : 5.716962;45.187654 : 5.704953;res-in;hinaura'
    );
  });
  ...
  it('should have only one cell for typologies', (): void => {
    ...
    expect(duplicationComparisonCSV).toBe<string>(
      'Score;Typologie 1;Typologie 2;Score Nom;Nom 1;Nom 2;Score Adresse;Adresse 1;Adresse 2;Distance en metres;Localisation 1;Localisation 2;Source 1;Source 2\n25;ESS;ESS,CAF,TIERS_LIEUX;38;Numerinaute;La Turbine.Coop;20;12 Rue Joseph Rey  chez Aconit 38000 Grenoble;5 esplanade Andry Farcy 38000 Grenoble;957;45.186115 : 5.716962;45.187654 : 5.704953;res-in;hinaura'
    );
  });
