...
import { fileName, toLieuxMediationNumeriqueCsv } from './output';

describe('output', (): void => {
  it('should generate file name', (): void => {
    const jsonFileName: string = fileName(new Date('2022-11-07'), '213502387', 'rhone', 'json');
