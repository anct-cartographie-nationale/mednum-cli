/**
 * Lieux écartés de la publication sur décision métier, indépendamment de la déduplication.
 */
export const EXCLUDED_LIEUX_IDS: string[] = [
  ...
  'dora_dora--04361a45-4926-4760-a409-605dc71e3025'
];
