...
const ZRRFromEquipementsSportsGouv = async (): Promise<ZrrTransfer[]> =>
  (
    await axios.get(
      'https://equipements.sports.gouv.fr/api/explore/v2.1/catalog/datasets/insee-zrr/exports/json?lang=fr&refine=zrr_simp:"C - Classée en ZRR"&timezone=Europe/Berlin'
    )
  ).data;
