...
export const TYPOLOGIE_MATCHERS: TypologieMatcher[] = [
  ...
  },
  {
    ...
    matchers: [/^communaut[ée] des? com(?:munes?)?/i, /^cdc(?:\W|$)/i, /^cc(?:\W|$)/i]
  },
  {
  ...
  },
  {
    ...
    matchers: [/(?:^|\W)CIAS(?:\W|$)/i, /centre intercommunal d[’'\s]action sociale/i]
  },
  {
  ...
  },
  {
    ...
    matchers: [/^CMS(?:\s|$)/i, /^PMS(?:\s|$)/i, /(?:Centre|P[oô]le|Relais) m[ée]dic(?:o|aux)\WSocia(?:l|ux)/i]
  },
  {
  ...
  },
  {
    ...
    matchers: [/(?:^|\W)CS(?:\W|$)/i, /(?:espace|c(?:en)?tre) (?:socia(?:l|ux)|soc\W)/i]
  },
  {
  ...
  },
  {
    ...
    matchers: [/(?:^|\W)EPI(?:\W|$)/i, /Espace Public (?:Internet|Informatique)/i]
  },
  {
  ...
  },
  {
    ...
    matchers: [/(?:^|\W)EVS(?:\W|$)/i, /Espace de Vie Sociale/i]
  },
  {
    typologie: Typologie.FABLAB,
    matchers: [/(?:^|\W)FAB\W?(?:LAB|AT)(?:\W|$)/i]
  },
  {
  ...
  },
  {
    ...
    matchers: [/Maison des Habitant/i]
  },
  {
  ...
  },
  {
    ...
    matchers: [/^Pr[ée]fecture/i, /^sous[-\s]pr[ée]fecture/i]
  },
  {
